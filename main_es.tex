...
\title[Análisis de Ciclo de Vida]{Análisis de Ciclo de Vida \\ \large Ejemplo Ilustrativo de la Producción de Electricidad}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item[3] \textbf{Extracción de Petróleo Crudo:} Se asume que no tiene consumos energía electrica pero si emisiones ambientales asociadas.
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item $A^{-1}$ es la inversa de la matriz tecnológica, que representa los requerimientos totales para cada unidad de proceso.
